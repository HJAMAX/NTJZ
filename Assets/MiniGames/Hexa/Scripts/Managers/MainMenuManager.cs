...
namespace MadFireOn
{
    public class MainMenuManager : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            quitBtn.GetComponent<Button>().onClick.AddListener(() => { QuitBtn(); });  //Challenge
