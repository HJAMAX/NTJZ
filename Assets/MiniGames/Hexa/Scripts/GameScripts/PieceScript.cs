    ...
    public class PieceScript : MonoBehaviour
    {
        ...
        void Update()
        {
            if (isRigidbody) {
                ...
                Rigidbody2D tigidbody = GetComponent<Rigidbody2D>();
                if (tigidbody == null) {
                ...
                //{
                    //myBody.isKinematic = isKinematic;
                //}
                //else
                //{
                //    myBody.isKinematic = true;
        ...
        void DetectThePiece()
        {
            ...
            {
                RaycastHit2D hit = Physics2D.Raycast(rayPos[i].position, -Vector3.up, 0.01f, pieceLayer);
                Debug.DrawRay(rayPos[i].position, -Vector3.up * 0.02f, Color.red);
